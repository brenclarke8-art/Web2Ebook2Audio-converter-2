...
class SettingsManager(QObject):
    ...
    DEFAULTS = {
        ...
        "dialogue_llm_delimiter_single_quotes": True,
        "dialogue_llm_delimiter_double_quotes": True,
        "dialogue_llm_delimiter_square_brackets": True,
        "dialogue_llm_delimiter_curly_braces": True,
        "dialogue_llm_delimiter_angle_brackets": True,
        "dialogue_llm_delimiter_parentheses": True,
        "dialogue_llm_batch_size": 0,
        "dialogue_llm_protocol_retries": 1,
